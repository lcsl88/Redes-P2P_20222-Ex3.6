...
def search():
	...
	encontrado = "Encontrado(s) o(s) seguinte(s) resultado(s) na busca no CryptoWiki:\n"
	bfind = False
...
def show():
	...
	encontrado = "Posts existentes no CryptoWiki:\n"
	bfind = False
...
my_label_frame = LabelFrame(root, text="Postar ou Procurar no CryptoWiki")
