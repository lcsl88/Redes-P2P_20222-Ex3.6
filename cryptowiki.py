...
def like():
	...
	if id_selecionado_like_dislike in dict_likes:
		dict_likes[id_selecionado_like_dislike] = dict_likes[id_selecionado_like_dislike] + 1
	clear()
	my_text.insert(0.0, "Postagem curtida! " + str(dict_likes[id_selecionado_like_dislike]) + " rep")
...
def dislike():
	...
	if id_selecionado_like_dislike in dict_likes:
		dict_likes[id_selecionado_like_dislike] = dict_likes[id_selecionado_like_dislike] - 1
	my_text.insert(0.0, "Postagem descurtida! " + str(dict_likes[id_selecionado_like_dislike]) + " rep")
